        ...
        <div id="main-div">
            ...
            <div class="one">
                ...
                <div class="entry-product">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                        ...
                        <select name="product_name" class="form-select form-select-sm"
                            aria-label=".form-select-sm example" id="product_name">
                            <?php
              $sq = "select * from product_details";
              $query = mysqli_query($conn, $sq);
              while ($res = mysqli_fetch_array($query)) {
              ?> <option><?php echo $res['product_name'] ?></option>
                            <?php
              }
              ...
              ?>
                        ...
                        <input class="product-text-field" id="product_qty" type="number" name="product_qty"
                            required><br>
